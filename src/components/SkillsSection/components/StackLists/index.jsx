                    ...
                    {stacks.map(lang => {
                        if(myRadio1.checked) {
                          if(lang.type === 0) {
                              return(
                                ...
                                <LangImg id={lang.name} src={`images/stackList/${lang.name}.svg`} alt={lang.desc}/>
                        ...
                        if(myRadio2.checked) {
                          if(lang.type === 1) {
                            return(
                              <StackWrapper>
                              <LangImg id={lang.name} key={lang.name} src={`images/stackList/${lang.name}.svg`} alt={lang.desc}/>
                              <StackTooltip>{lang.desc}</StackTooltip>
                              </StackWrapper>
                            )
                          } else {
